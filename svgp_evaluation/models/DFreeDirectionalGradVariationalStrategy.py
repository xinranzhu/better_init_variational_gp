...
class DirectionalGradVariationalStrategy(_VariationalStrategy):
    ...
    def forward(self, x, inducing_points, inducing_values,variational_inducing_covar=None, **kwargs):
        ...
        # print("num_derivative_directions = ", num_derivative_directions)
        # print("derivative_directions.shape = ", derivative_directions.shape)
        # print(type(self.model.covar_module.base_kernel))
        ...
        induc_induc_covar = full_output.lazy_covariance_matrix
        kwargs['v1'] = derivative_directions.to(x.device)
        kwargs['v2'] = derivative_directions.to(x.device)
        # self.model.covar_module.base_kernel.set_num_directions(num_directions,num_derivative_directions)
        self.model.covar_module.set_num_directions(num_directions,num_derivative_directions)
        ...
        # print("induc_data_covar = ", induc_data_covar)
        # print("induc_induc_covar = ", induc_induc_covar.evaluate())
        # print("interp_term_trans = ", interp_term_trans)
