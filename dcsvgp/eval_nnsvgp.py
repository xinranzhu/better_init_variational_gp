...
from models.nnsvgp import GPModel, train_gp, eval_gp
...
class NNSVGP_exp(Experiment):
    def __init__(self,**kwargs):
        super().__init__(**kwargs, model="NNSVGP")
    ...
    def train(self, lr=0.1, num_epochs=10, 
        ...
        load_run_path = self.save_path + "_" + mll_type + f"_alpha_None" + "_" + load_run + ".model" if load_run is not None else None
