...
from models.dkl_input_space_u import GPModelDKL
from models.dkl_input_space_u import train_gp, eval_gp
...
class DKL_exp(Experiment):
    def __init__(self,**kwargs):
        super().__init__(**kwargs, model="DKL_input_space_u")
